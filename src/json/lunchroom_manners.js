              ...
              body: [
                {
                  ...
                  items: [
                    {
                      id: 'https://dlib.indiana.edu/iiif_av/lunchroom_manners/high/lunchroom_manners_1024kb.mp4#t=23.5,250',
                      type: 'Video',
                      format: 'video/mp4',
                      label: {
                        en: ['High'],
                    ...
                    {
                      id: 'https://dlib.indiana.edu/iiif_av/lunchroom_manners/medium/lunchroom_manners_512kb.mp4#t=23.5,250',
                      type: 'Video',
                      format: 'video/mp4',
                      label: {
                        en: ['Medium'],
                    ...
                    {
                      id: 'https://dlib.indiana.edu/iiif_av/lunchroom_manners/low/lunchroom_manners_256kb.mp4#t=23.5,250',
                      type: 'Video',
                      format: 'video/mp4',
                      label: {
                        en: ['Low'],
