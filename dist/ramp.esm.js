...
var VideoJSProgress = /*#__PURE__*/function (_vjsComponent) {
  ...
  _createClass(VideoJSProgress, [{
    ...
    value: function mount() {
      this.options.setPortal( /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React.createElement(ProgressBar, null), this.el()));
    }
  }]);
...
var MarkerContainer = function MarkerContainer(_ref) {
  ...
  var ctx = useContext(PlayerStateContext);
...
var ProgressBar = function ProgressBar() {
  var playerCtx = useContext(PlayerStateContext);
  ...
  useRef(timeToHHmmss(playerCtx.player.currentTime()));
  ...
  var containerRectRef = useRef(null);
  ...
  var onMouseMove = useMemo(function () {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(MarkerContainer, {
    duration: duration
    ...
    ref: tooltipRef
  }, timeToHHmmss(tooltipOffset * duration)), /*#__PURE__*/React.createElement("div", {
...
var VideoJSFileDownload = /*#__PURE__*/function (_vjsComponent) {
  ...
  _createClass(VideoJSFileDownload, [{
    key: "mount",
    value: function mount() {
      ReactDOM.render( /*#__PURE__*/React.createElement(Downloader, {
...
function VideoJSPlayer(_ref) {
  ...
  var lastSearchMarkers = React.useRef(searchMarkers);
...
var StructuredNavigation = function StructuredNavigation() {
  ...
  }, "Empty structure in manifest") : /*#__PURE__*/React.createElement("p", {
    className: "ramp--no-structure"
...
var TranscriptSelector = function TranscriptSelector(_ref) {
  var setTranscript = _ref.setTranscript,
    ...
    machineGenerated = _ref.machineGenerated;
  var _React$useState = React.useState(tId),
    _React$useState2 = _slicedToArray(_React$useState, 2),
  ...
  if (transcriptData) {
    ...
    }), machineGenerated && /*#__PURE__*/React.createElement("p", {
    ...
    if (searchResults.ids.length === 0) {
      ...
      if (focusedMatchIndex !== null) {
        resultNavigation = /*#__PURE__*/React.createElement("div", {
          ...
          className: "ramp--transcript_search-count"
        }, focusedMatchIndex + 1, " of ", searchResults.ids.length), /*#__PURE__*/React.createElement("button", {
...
function getSupplementingTranscripts(canvasId, item, index) {
  ...
  var data = fetch(url).then(function (response) {
    ...
    var manifest = parseManifest(data);
...
var refineMatch = function refineMatch(match, query) {
  ...
  while (true) {
    ...
    var truncatedResult = fuzzysort.single(query, truncatedText);
    if (truncatedResult) {
      offset += start;
...
var defaultMatcher = function defaultMatcher(query, items) {
  ...
  var rawResults = fuzzysort.go(query, wrapped, {
    key: 'text'
  }).map(function (result) {
...
var Transcript = function Transcript(_ref) {
  ...
  var _React$useState5 = React.useState( /** @type {TranscriptSearchResults} */{
      results: {},
      ids: [],
      idsScored: []
    }),
  ...
  var followingVideo = useRef(followVideo);
  var searchResultsRef = useRef(searchResults);
  ...
  var transcriptContainerRef = useRef(null);
  var transcriptRef = useRef(transcript);
  ...
  var areTranscriptsSplit = useMemo(function () {
    if (transcript.length && typeof transcript[0] === 'string') return false;else return true;
  }, [transcript]);
  var areTranscriptsTimed = useMemo(function () {
  ...
  var lastFocusedLine = useRef(focusedLine);
  var lastResultsRef = useRef(searchResults);
  useEffect(function () {
  ...
  var fetchManifestData = React.useCallback( /*#__PURE__*/function () {
    ...
    if (transcripts && transcripts.length > 0) {
      if (typeof transcript[0] == 'string') {
        ...
        transcript.forEach(function (t) {
          ...
          }, item.begin && /*#__PURE__*/React.createElement("span", {
            className: "ramp--transcript_time",
            "data-testid": "transcript_time"
          }, /*#__PURE__*/React.createElement("a", {
            href: '#'
          }, "[", createTimestamp(item.begin, true), "]")), /*#__PURE__*/React.createElement("span", {
  ...
  if (!isLoading) {
    ...
    }), showSelect && /*#__PURE__*/React.createElement(TranscriptSelector, {
